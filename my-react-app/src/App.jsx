        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 text-center">
            ...
            <div className="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
                ...
                <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
                    <a href="#" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-indigo-300 bg-gray-700 hover:bg-gray-600 md:py-4 md:text-lg md:px-10">
                        Learn How to Sell
                    </a>
                </div>
            </div>
        ...
        <div className="w-full aspect-w-1 aspect-h-1 bg-gray-700 rounded-lg overflow-hidden xl:aspect-w-7 xl:aspect-h-8">
            <img
                ...
                onError={(e) => {
                    ...
                    fallback.className = 'w-full h-full flex items-center justify-center bg-gray-600 text-gray-400';
